...
int main() {
  ...
  36:	68078793          	addi	a5,a5,1664 # 989680 <__global_pointer$+0x9885f7>
  ...
  6c:	7e850513          	addi	a0,a0,2024 # 850 <malloc+0xe6>
  70:	00000097          	auipc	ra,0x0
  74:	63c080e7          	jalr	1596(ra) # 6ac <printf>
  exit(0);
  78:	4501                	li	a0,0
  7a:	00000097          	auipc	ra,0x0
  7e:	2aa080e7          	jalr	682(ra) # 324 <exit>
  for(;n > 0; n--) {
  ...
  94:	334080e7          	jalr	820(ra) # 3c4 <waitx>
...
free(void *ap)
{
 ...
 6f0:	1a47b783          	ld	a5,420(a5) # 890 <freep>
...
malloc(uint nbytes)
{
 ...
 792:	10253503          	ld	a0,258(a0) # 890 <freep>
 ...
 7ba:	0da90913          	addi	s2,s2,218 # 890 <freep>
  if(p == (char*)-1)
 7be:	5afd                	li	s5,-1
 7c0:	a88d                	j	832 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7c2:	00000797          	auipc	a5,0x0
 7c6:	0d678793          	addi	a5,a5,214 # 898 <base>
 7ca:	00000717          	auipc	a4,0x0
 7ce:	0cf73323          	sd	a5,198(a4) # 890 <freep>
 7d2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7f4:	0aa73023          	sd	a0,160(a4) # 890 <freep>
      return (void*)(p + 1);
