...
main(int argc, char ** argv) 
{
  ...
  36:	82650513          	addi	a0,a0,-2010 # 858 <malloc+0xf6>
  ...
  50:	7fc50513          	addi	a0,a0,2044 # 848 <malloc+0xe6>
  ...
  98:	7d450513          	addi	a0,a0,2004 # 868 <malloc+0x106>
  9c:	00000097          	auipc	ra,0x0
  a0:	608080e7          	jalr	1544(ra) # 6a4 <printf>
  }
  exit(0);
  a4:	4501                	li	a0,0
...
putc(int fd, char c)
{
 ...
 3e2:	f66080e7          	jalr	-154(ra) # 344 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 414:	47850513          	addi	a0,a0,1144 # 888 <digits>
 418:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e0:	3acb8b93          	addi	s7,s7,940 # 888 <digits>
 ...
 620:	26490913          	addi	s2,s2,612 # 880 <malloc+0x11e>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e8:	1bc7b783          	ld	a5,444(a5) # 8a0 <freep>
 ...
 716:	00e6ea63          	bltu	a3,a4,72a <free+0x50>
{
 ...
 758:	14f73623          	sd	a5,332(a4) # 8a0 <freep>
}
 75c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 78a:	11a53503          	ld	a0,282(a0) # 8a0 <freep>
 ...
 7b2:	0f290913          	addi	s2,s2,242 # 8a0 <freep>
  if(p == (char*)-1)
 7b6:	5afd                	li	s5,-1
 7b8:	a88d                	j	82a <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7ba:	00000797          	auipc	a5,0x0
 7be:	0ee78793          	addi	a5,a5,238 # 8a8 <base>
 7c2:	00000717          	auipc	a4,0x0
 7c6:	0cf73f23          	sd	a5,222(a4) # 8a0 <freep>
 7ca:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7ec:	0aa73c23          	sd	a0,184(a4) # 8a0 <freep>
      return (void*)(p + 1);
 ...
 83a:	b76080e7          	jalr	-1162(ra) # 3ac <sbrk>
  if(p == (char*)-1)
